...
(you can pause here and try implement some of the other cool features of liquid you can read about [here](https://liquidjs.com/tutorials/intro-to-liquid.html)).
